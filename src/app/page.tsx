      ...
      <div className="grid lg:grid-cols-2 gap-8 items-center py-12 md:py-20">
        <div className="space-y-6 text-center lg:text-left">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-foreground">
            <span className="block">Summer Styles</span>
            <span className="block text-primary">Are Finally Here</span>
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground max-w-xl mx-auto lg:mx-0">
            Discover the latest trends in fashion and get ready to update your wardrobe with our new summer collection.
          </p>
        ...
        <div className="relative h-64 md:h-96 lg:h-full">
          <Image
            ...
            data-ai-hint="fashion summer collection"
          />
        </div>
      </div>
    </div>
